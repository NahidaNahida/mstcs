...
def testing_process_MSTCs_MPS(program_version, if_swap_list, inputs_list, mixed_pre_mode, repeats=20):
    """
            ...
            for if_swap in if_swap_list:
                for temp_state in state_list:
                    ...
                    if temp_state == "mixed":
                        ...
                        exp_probs = PSTC_specification(n, 2 ** n - 1, if_swap)
...
if __name__ == '__main__':
    ...
    for program_version in ["v1", "v2", "v3", "v4", "v5", "v6"]:
        ...
        recorded_result = recorded_result + testing_process_MSTCs_1MS(program_version, if_swap_list, inputs_1MS, 'bits')
        recorded_result = recorded_result + testing_process_MSTCs_1MS(program_version, if_swap_list, inputs_1MS, 'qubits')
        recorded_result = recorded_result + testing_process_MSTCs_MPS(program_version, if_swap_list, inputs_MPS_sep, 'bits')
        recorded_result = recorded_result + testing_process_MSTCs_MPS(program_version, if_swap_list, inputs_MPS_sep, 'qubits')
        recorded_result = recorded_result + testing_process_MSTCs_MPS(program_version, if_swap_list, inputs_MPS_ent, 'bits')
        recorded_result = recorded_result + testing_process_MSTCs_MPS(program_version, if_swap_list, inputs_MPS_ent, 'qubits')
        # save the data
        program_name = 'QFT'
