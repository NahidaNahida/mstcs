...
if __name__ == '__main__':
    ...
    for program_version in ["v1", "v2", "v3", "v4", "v5"]:
        ...
        recorded_result = recorded_result + testing_process_MSTCs_MPS(program_version, if_swap_list, inputs_MPS, 'bits')
        recorded_result = recorded_result + testing_process_MSTCs_MPS(program_version, if_swap_list, inputs_MPS, 'qubits')
