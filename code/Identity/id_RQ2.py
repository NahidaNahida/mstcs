...
def testing_process_MSTCs_1MS(inputs_list, mixed_pre_mode, repeats=20):
    """
    ...
    for inputs in inputs_list:
        ...
        for _ in range(repeats):
            ...
            for MSB_val in MSB_val_list:
                ...
                # derive the test result by nonparametric hypothesis test
                test_result = OPO_UTest(exp_samps, test_samps)
                # print(test_result, exp_probs, dict_counts, input_name)
    ...
    for inputs in inputs_list:
        ...
        for _ in range(repeats):
            ...
            for temp_state in state_list:
                test_cases += 1
                if temp_state == 'mixed':
                    qc = QuantumCircuit(n + m, n + m)       # necessary to save the output of control qubits
...
if __name__ == '__main__':
    ...
    # the test processes
    recorded_result = []
    recorded_result = recorded_result + testing_process_MSTCs_2MS(inputs_2MS, 'bits')
    recorded_result = recorded_result + testing_process_MSTCs_2MS(inputs_2MS, 'qubits')
