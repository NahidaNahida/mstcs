...
def testing_process_MSTCs(program_version, n_list, slop_list, offset_list, domain_list, image_list, mode, repeats=20):    
    program_name = 'LinearAmplitudeFunction'
    default_shots = 1024
...
if __name__ == '__main__':
    ...
    for program_version in ['v1', 'v2', 'v3', 'v4', 'v5', 'v6']:
        ...
        testing_process_MSTCs(program_version, n_list, slop_list, offset_list, domain_list, image_list, 'bits')
        testing_process_MSTCs(program_version, n_list, slop_list, offset_list, domain_list, image_list, 'qubits')