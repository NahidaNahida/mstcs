...
def testing_process_PSTCs(program_version, n, slop_list, offset_list, shots_list, repeats=20):
    program_name = 'LinearPauliRotations'
...
if __name__ == '__main__':
    ...
    for program_version in program_versions:
        ...
        testing_process_MSTCs_2MS(program_version, slop_list, offset_list, inputs_2MS, 'qubits', shots_list)
        testing_process_MSTCs_1MS(program_version, slop_list, offset_list, inputs_1MS, 'qubits', shots_list)
        testing_process_PSTCs(program_version, n, slop_list, offset_list, shots_list)
    print('done!')