...
of the quantum circuits involved in program `LinearPauliRotations`, including 
...
if __name__ == '__main__':
    ...
    for i in [1, 3]:  
        ...
        classical_inputs_tuple = product(
            module.config_dict["all"]["slop_list"],
            module.config_dict["all"]["offset_list"]
        )
